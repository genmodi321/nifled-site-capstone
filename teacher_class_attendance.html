        ...
        <div class="col">
          ...
          <div class="container-fluid actual-content">
            <div class="container wd-75">
              ...
              <br>
              <div class="d-flex align-items-center">
                <h5 class="bold"><span><i class="bi bi-arrow-left-circle-fill" onclick="redirect()"></i> </span> Scan QR Code</h5>
              ...
              <div id="attendance"
                ...
                <br>
                <p class="info">Western Mindano State University <br>
                  College of Computing Studies <br>
                  <span class="bold">Department of Information
                    Technology</span><br>
                  Zamboanga City
                </p>
                <br>
                <div class="row">
                  <div class="col">
                    ...
                    <p class="bold">Capstone I</p>
                  </div>
                  <div class="col">
                    <p class="bold">ATTENDANCE</p>
                  </div>
                  <div class="col">
                    <p class="bold">August 15, 2024 <br> 11:00 PM</p>
                    <p></p>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col">
                    ...
                    <p class="bold">Present - <i
                        ...
                        class="bi bi-check-square-fill"> </i></p>
                ...
                <div class="row">
                  <div class="col">
                    <p class="bold">1.) Abrajano, John Paulo</p>
                  </div>
                  <div class="col">
                    <hr class="liner">
                  </div>
                  <div class="col">
                    <p class="bold"><i class="bi bi-check-square-fill"> </i></p>
                  </div>
                </div>

                <div class="row">
                  <div class="col">
                    <p class="bold">2.) Aquino, Leonard</p>
                  </div>
                  <div class="col">
                    <hr class="liner">
                  </div>
                  <div class="col">
                    <p class="bold"><i class="bi bi-square"> </i></p>
                  </div>
                </div>
