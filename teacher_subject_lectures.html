      ...
      <div class="row">
        ...
        <div class="col-md-2 sidebar text-center">
          ...
          <div class="navigation-links" style="text-align: left;">
            ...
            <a href="teacher_dashboard.html"><p><i class="bi bi-kanban"></i>
                Index</p></a>
            <hr>
        ...
        <div class="col">
          ...
          <div class="container-fluid actual-content">
                ...
                <div class="d-flex align-items-center">
                  <h3>Welcome to your Dashboard!
                    ...
                    <p class="fs-small mt-10"> <a
                      ...
                      <span
                        class="nav-ham-link">Lectures</span></p>
                  </h3>
              ...
              <div class="container file-container">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="d-flex align-items-center">
                            <h5>Lecture 1: Basics of Capstone</h5>
                            <div class="ms-auto text-center">
                                <p class=bold>8/17/2024</p>
                                <a download="test_document.pdf" href="test_document.pdf" style="color: black !important"> <h5 class="bi bi-download bold"></h5></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container file-container">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="d-flex align-items-center">
                            <h5>Lecture 2: How to make an RRL</h5>
                            <div class="ms-auto text-center">
                                <p class=bold>8/17/2024</p>
            ...
            <div class="container file-container">
                <div class="row">
                    <div class="col-sm-1 text-center">
                        <h1 class="bi bi-file-word" style="font-size:64px;"></h1>
                    </div>
                    <div class="col">
                       
                        <div class="d-flex align-items-center">
                            <h5>Lecture 3: Activity Guide: Creating an RRL</h5>
                            <div class="ms-auto text-center">
                                <p class=bold>8/17/2024</p>
                                <h5 class="bi bi-download bold"></h5>
                            </div>
