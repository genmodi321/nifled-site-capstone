        ...
        <div class="col">
          ...
          <div class="container-fluid actual-content">
           ...
           <div class="container-fluid">
            ...
            <br>
            <div class="row text-center d-flex justify-content-center align-content-center">
              <div class="col-md-3 class-container">
                <p><i class="bi bi-journal-album"></i> <b> Subject:</b> Capstone 1 & Research</p>
                <p><i class="bi bi-calendar"></i> <b> Class:</b> BSIT-4A </p>
                <p><i class="bi bi-calendar"></i> <b> Semester:</b> 1st Semester </p>
                <p><i class="bi bi-file-person"></i> <b> Students:</b> 50 </p>
                <button class="btn btn-csms-outlined" onclick="gotoSubject()">Open</button>
